...
class Base(object):
    ...
    def yolo_loss(self, args, anchors, num_classes, ignore_thresh=.5, print_loss=False):
        ...
        for l in range(num_layers):
            ...
            grid, raw_pred, pred_xy, pred_wh = self.yolo_head(yolo_outputs[l],
    ...
    def create_model(self, input_shape, class_names, anchors,weights_path, load_pretrained=True, freeze_body=True):
