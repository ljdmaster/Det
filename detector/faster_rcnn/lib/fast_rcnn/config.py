...
# Data directory
__C.DATA_DIR = osp.abspath(osp.join(__C.ROOT_DIR, './experiments/data'))
...
def get_output_dir(imdb, weights_filename):
    ...
    (if not None).
    """
    outdir = osp.abspath(osp.join(__C.ROOT_DIR, './experiments/output', __C.EXP_DIR, imdb.name))
...
def get_log_dir(imdb):
    ...
    (if not None).
    """
    log_dir = osp.abspath(osp.join(__C.ROOT_DIR, './experiments/logs', __C.EXP_DIR, imdb.name, strftime("%Y-%m-%d-%H-%M-%S", localtime())))
